...
export function Footer() {
  ...
  const footerLinks = {
    product: [
      { label: t.footer.aiStudio, href: '/studio' },
  ...
  return (
    <footer className="border-t border-[#333333] bg-[#080808]">
      <div className="max-w-[1440px] mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              <BrickLogo />
              <div>
                <div className="text-white font-display">InfiniteBrick AI</div>
          ...
          {/* Product */}
          <div>
            <h4 className="text-white mb-4">{t.footer.product}</h4>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-white mb-4">{t.footer.resources}</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-[#333333] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © 2024 InfiniteBrick AI. {t.footer.allRights}
          </p>
